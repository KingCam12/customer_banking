...
def create_savings_account(balance, interest_rate, months):
  ...
  # Create an instance of the `Account` class and pass in the balance and interest rate as 0 for now.
    savings_account = Account(balance, 0)
    
    # Calculate interest earned using the formula (assuming interest_rate is an annual percentage).
